    ...
    export default {
        ...
        beforeMount() {
            this.axios.get('/stats', {
                ...
                this.request.before_date = new Date(dt.first[0], dt.first[1] - 1, dt.first[2] + 1, dt.first[3] || 0, dt.first[4] || 0, dt.first[5] || 0, 0);
                this.request.after_date = this.maxDate
        ...
        methods: {
            resetData() {
                console.log('start reseting data')
                this.axios.get('/stats', {
                    params: this.request
                }).then(resp => {
                    this.stats = resp.data;
                    ...
                    console.log('reseting data was success')
                }).catch(err => {
